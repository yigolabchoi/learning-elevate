...
export const FeedbackDetail = () => {
  ...
  return (
    <Page>
      ...
      {/* 점수 카드 */}
      <Card className="mb-6 border-2 border-primary-300 bg-linear-to-r from-primary-50 to-blue-50">
        <Card.Body>
      ...
      <Card className="mb-6">
        <Card.Body>
          <div className="flex items-start gap-3">
            <svg className="w-6 h-6 text-purple-600 shrink-0 mt-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
