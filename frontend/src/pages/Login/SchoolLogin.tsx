/**
 * School Login Page - 교육기관용 로그인
 * 
 * 관리자와 선생님을 위한 전용 로그인 페이지
 * 심플하고 전문적인 디자인
 */
...
export const SchoolLogin = () => {
  ...
  const handleSubmit = async (e: FormEvent) => {
    ...
    try {
      const mockEmailMap: Record<'admin' | 'teacher', string> = {
  ...
  const quickLogin = async (targetRole: 'admin' | 'teacher') => {
    setIsLoading(true);
    setError('');
